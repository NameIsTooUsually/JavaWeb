...
import com.chenhao.homework.test2.OrderDetail;
import com.chenhao.homework.test2.Orders;
...
public class Test2 {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //开启线程 执行
            Thread thread1 = new Thread(new RunnableOrder_detail(list, orders, connection));
            Thread thread2 = new Thread(new RunnableOrders(orders, connection));
            thread1.start();
            thread2.start();
            //提交事务
            Thread.sleep(2000);
